...
import za.co.absa.spline.gateway.rest.model.{AttributeRef, Operation, OperationDetails}
import za.co.absa.spline.persistence.model._

class OperationDetailsConverterTest extends FunSuite with BeforeAndAfterEach {


  trait TestOperationDetails {
    ...
    private val schemasDefinition = Array[DataType](
  ...
  test("Test the schema definition reduction for a given operation.") {
    new TestOperationDetails {
      val operationDetailsConverted = new OperationDetailsConverter().reduceSchemaDefinition(operationDetails)
      assert(operationDetailsConverted.schemasDefinition.length == 12, "The converted operation details should contains 12 different dataTypes")
      val dataTypeIds = operationDetailsConverted.schemasDefinition.map(dt=>dt._key)
      assert(dataTypeIds.contains("021fda3e-0cb2-4121-8d80-f3eb3889653a"))
      assert(dataTypeIds.contains("7c9fc3e9-30e1-4a51-918f-fdaeac32744f"))
      assert(dataTypeIds.contains("d64a20af-86fe-413e-baca-83b4e677e2c2"))
      assert(dataTypeIds.contains("5d6d8b67-95cc-464c-9f7c-952b20201245"))
      assert(dataTypeIds.contains("92242e53-eaea-4c5b-bc90-5e174ab3e898"))
      assert(dataTypeIds.contains("2b737c59-6443-4a2a-80c3-a99709b306a6"))
      assert(dataTypeIds.contains("7c115a74-9fbd-49cd-b215-ad8f43ded504"))
      assert(dataTypeIds.contains("602147fa-7148-46a7-9978-ba9f63f6b616"))
      assert(dataTypeIds.contains("d41bc4c9-8f61-49ee-9b28-5fe7afb92076"))
      assert(dataTypeIds.contains("951f2d88-f8b4-4bc8-b5bf-524811c9197a"))
      assert(dataTypeIds.contains("eefa2d78-af41-41eb-ac5c-518e234cfd4c"))
      assert(dataTypeIds.contains("c633cbc0-688c-4cf8-b044-5261082b7f50"))
