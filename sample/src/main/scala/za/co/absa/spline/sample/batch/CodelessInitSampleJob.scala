...
object CodelessInitSampleJob extends SparkApp(
  ...
  // Spark configuration used to register Spline listener.
  conf = Seq(("spark.sql.queryExecutionListeners", "za.co.absa.spline.core.listener.CodelessQueryExecutionListener"))) {
